...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '苏如煦', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一個瞎搞網絡的法學廢物', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion.nocloudy.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '晴天之上,nocloudy,suruxu,苏如煦', // 网站关键词 英文逗号隔开
  ...
  NOTION_HOST: process.env.NEXT_PUBLIC_NOTION_HOST || 'https://notion.nocloudy.top', // Notion域名，您可以选择用自己的域名进行反向代理，如果不懂得什么是反向代理，请勿修改此项
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || '晴天之上', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
    process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || '/bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || 'NoCloudy', // 站点描述，被notion中的页面描述覆盖
